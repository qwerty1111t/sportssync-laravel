...
<div class="auth-wrap">
    <div class="auth-card">
        ...
        @elseif (session('status') == 'pending-approval')
            <div class="verify-status warning">
                <span class="vs-icon">⏳</span>
                <span>Your account has been verified, but committee access is still pending approval. You will be granted access once an administrator approves your request.</span>
            </div>
        @else
