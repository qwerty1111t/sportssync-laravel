...
<title>Superadmin Login — SportSync</title>
...
<div class="auth-wrap">
    ...
    <div class="auth-card">
        ...
        <div class="auth-header">
            <h1 class="auth-title">Superadmin Sign In</h1>
            <p class="auth-sub">Restricted access — superadmin only</p>
        </div>
        ...
        <form class="auth-form" method="POST" action="{{ route('superadmin.login') }}">
            ...
            <div class="block mt-4" style="display:flex;align-items:center;justify-content:space-between;gap:12px;">
                ...
                <div>
                    <a href="{{ route('superadmin.password.request') }}" class="auth-forgot">Forgot your password?</a>
                </div>
            </div>
        ...
        <p class="auth-switch">
            This page is for superadmin accounts only.
        </p>
    </div>
