...
error_log('[table-tennis db_config] Attempting connection to ' . $dbHost . ' user=' . $dbUsername);

$mysqli = @new mysqli($dbHost, $dbUsername, $dbPassword, $dbName);
if ($mysqli->connect_errno) {
    @file_put_contents(__DIR__ . '/tabletennis_debug.log', date('[Y-m-d H:i:s] ') . "DB connect error to " . $dbHost . ": " . $mysqli->connect_error . "\n", FILE_APPEND);
    error_log('[table-tennis db_config] Connection failed: ' . $mysqli->connect_error);
